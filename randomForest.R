...
#############################revisamos el csv y nos damos cuenta en donde se esta equivocando el algoritmo
########################## en función de eso, acemos unas declaraciones lógicas para mejorar las predicciones
